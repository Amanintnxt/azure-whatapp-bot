...
def whatsapp_webhook():
    ...
    try:
        ...
        # ---- STEP 1: Reply immediately with "typing..." ----
        typing_resp = MessagingResponse()
        typing_resp.message("⏳ Typing...")
        # Send this interim response first
        response_str = str(typing_resp)

        # ---- STEP 2: Process assistant in background ----
        reply = process_with_assistant(from_number, incoming_msg)

        # Send final AI reply via Twilio REST API
        ...
        return response_str  # immediate typing reply
